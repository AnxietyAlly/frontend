...
<div class="h-20 mt-4 space-y-6">
	<div class="flex justify-center">
		<div class="w-full md:w-3/4 lg:w-1/2 bg-white bg-opacity-50 p-4 mx-4">
			<div class="mx-auto mt-2">
				...
				{#key isEditingInfo}
					<button on:click={toggleIsEditingInfo} class="rounded-xl {editButtonWidth} bg-red-300 m-2 mt-5">
						{#if isEditingInfo}
							<div class="m-1">
				...
				<div class="flex flex-auto gap-2 mt-20 items-center">
					<a
						href="/logout"
						class="rounded-xl bg-red-400 w-28 flex flex-auto gap-2"
						data-sveltekit-preload-data="off"
						data-sveltekit-reload
					>
						<img src="/logout.png" alt="Logout icon" class="w-8 h-8 my-2 ml-2">
						<h3 class="self-center justify-self-end my-2">Log out</h3>
					</a>
				
					<button on:click={toggleIsTryingToRemoveAccount} class="rounded-xl bg-red-500 flex flex-auto gap-2">
